    ...
    <>
      ...
      <div className="container mt-5 section contact-section shadow-lg bg-light">
        ...
        <div className="contact-info">
          <div className="c-info-heading">Connect to Us For Any Information </div>
          {/* info */}
          <div className="c-info-group">
            <div>
              <GoLocation /> <span>HELP</span>
            </div>

            <p>
              This is the AI which will clear any problem which arrises while going this
            </p>
          </div>
          {/* info */}
          {/* info */}
